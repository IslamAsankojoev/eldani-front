...
const Page = () => {
  return (
    <div className="mx-auto my-0 h-full w-full py-10 md:w-4/6 ">
      <div className='p-10 bg-stone-920/60 backdrop-blur-md'>
      ...
      <Accordion type="single" collapsible className="w-full">
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent>
            ...
            <ul className='!list-disc gap-2'>
              ...
              <li>
                4. Заполнить необходимые поля для доставки и выбрать способ оплаты.
              </li>
              <li>
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent>
            Все наши паттерны предоставляются в PDF формате, который можно легко
            скачать и распечатать дома или в любом месте, где есть доступ к
            принтеру. Для просмотра и печати файлов вам понадобится Adobe Reader
            или любое другое ПО, которое поддерживает формат PDF.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-4">
          ...
          <AccordionContent>
            ...
            предложить возврат или обмен после того, как файл был отправлен или
            загружен. Однако мы стремимся к тому, чтобы все наши клиенты были
            довольны покупкой. Если у вас возникнут проблемы с вашим заказом,
            пожалуйста, свяжитесь с нашей службой поддержки для решения вопроса.
          </AccordionContent>
        </AccordionItem>
        <AccordionItem value="item-5">
          <AccordionTrigger>
            Могу ли я использовать ваши паттерны для коммерческого производства
            одежды?
          </AccordionTrigger>
          <AccordionContent>
